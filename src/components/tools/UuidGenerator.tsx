      ...
      <div className="space-y-3">
        ...
        {uuid && (
          <div className="flex items-center gap-2">
            <code className="flex-1 rounded-md bg-gray-50 border border-gray-200 px-3 py-2 text-sm font-mono">
              {uuid}
            </code>
            <Button
              variant="outline"
        ...
        {bulkUuids.length > 0 && (
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500">{bulkUuids.length} UUIDs</span>
              <Button
                variant="outline"
                size="sm"
            ...
            >
              {bulkUuids.map((id, i) => (
                <li key={i} className="flex items-center justify-between px-3 py-1.5 hover:bg-gray-50">
